 ...
 *
 * !!! BROKEN !!! http://docs.jquery.com/UI/Menubar
 ...
 *	jquery.ui.menu.js
 *
 * This menubar is work in progress and will hopefully be included in a future jquery ui relase.
 *
 * @author Johan Andersson
 * Additions/changes included to make the menubar close on clicks outside of it and not close if the mouse is moved
 * outside of an open drop down menu.
 *
 */
(function( $ ) {
...
//			},
        ...
        // This makes open menus close on clicks outside of themselves, http://stackoverflow.com/a/1160926
        $('body').bind('click', function(e) {
            if($(e.target).closest(".ui-menubar-item").length == 0) {
                that._close(e);
            }
        });
	},
